...
#### 1. back to top
#####-------------------------------------------------------------------------------**[expample](http://zhansingsong.github.io/back2top)**
HTML structure:
```javascript
...
#####-------------------------------------------------------------------------------**[expample](http://zhansingsong.github.io/iElevator)**
HTML structure:  
...
#####-------------------------------------------------------------------------------**[expample](http://zhansingsong.github.io/iElevator-back2top)**
HTML structure:
```javascript
...
#####-------------------------------------------------------------------------------**[expample](http://zhansingsong.github.io/segmentfault)**
Javascript:
```javascript
    // 获取Markdown中的标题
    var $demo = $('#demo'),
